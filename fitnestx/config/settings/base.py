...
MIGRATION_MODULES = {"sites": "fitnestx.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "fitnestx.users.context_processors.allauth_settings",
            ],
        },
    },
]
...
# Raw Data from meal
RAW_DATA_FILEPATH = "fitnestx/static/csv_data/raw_food_data.csv"
