...
from fitnestx.meal.serializers import CategorySerializer

@pytest.mark.django_db
def test_category_list_filtered(api_client):
    ...
    # Make a GET request to the category-list-filtered endpoint with authentication header
    url = reverse('api_v1:meal-user:users-meal:category-list-filtered', args=[meal.id])
    headers = {
    ...
    # Check if the response data matches the serialized category data
