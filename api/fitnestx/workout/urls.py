...
from .views import EquipmentList, EquipmentDetail, ExerciseList, ExerciseDetail, ExercisePerformDetails, ExercisePerformList, WorkoutList, WorkoutDetail, WorkoutExerciseList, WorkoutExerciseDetail
