...
class _MealScheduleViewState extends State<MealScheduleView> {
  ...
  Future<void> fetchMealScheduleScreenData() async {
    await fetchMealScheduleData(currentCalenderData);
    fetchNutritionData(currentCalenderData);
  }
